...
columns = ["Cloud Service Description", "Unit Quantity", "Annual Unit Fee", "Additional Licenses", "Monthly Co-Termed Cost", "First Year Co-Termed Cost", "Prepaid Co-Termed Cost", "Updated Annual Cost", "Subscription Term Total Service Fee"]
